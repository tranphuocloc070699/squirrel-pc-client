<template>
    ...
    :icon="`/star.svg`"
    >
    <select v-model="selectedCountry" class="block w-full px-4 py-2 text-center leading-tight bg-white border border-gray-400 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500">
